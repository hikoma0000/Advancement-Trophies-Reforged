...
public class ClientSetup {
    public static void init(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(ModContainers.TROPHY_CRATE_CONTAINER.get(), (TrophyCrateContainer container, Inventory inv, Component title) -> new TrophyCrateScreen<>(container, inv, title));
            MenuScreens.register(ModContainers.TROPHY_CRATE_ITEM_CONTAINER.get(), (TrophyCrateItemContainer container, Inventory inv, Component title) -> new TrophyCrateScreen<>(container, inv, title));
