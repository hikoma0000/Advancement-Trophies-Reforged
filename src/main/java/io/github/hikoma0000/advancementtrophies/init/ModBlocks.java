...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(BuiltInRegistries.BLOCK, AdvancementTrophies.MOD_ID);

    public static final Supplier<Block> IRON_TROPHY = BLOCKS.register("iron_trophy",
    ...
    public static final Supplier<Block> GOLD_TROPHY = BLOCKS.register("gold_trophy",
            () -> new TrophyBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0F, 5.0F).sound(SoundType.METAL).noOcclusion()));

    public static final Supplier<Block> DIAMOND_TROPHY = BLOCKS.register("diamond_trophy",
            () -> new TrophyBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0F, 5.0F).sound(SoundType.METAL).noOcclusion()));

    public static final Supplier<Block> NETHERITE_TROPHY = BLOCKS.register("netherite_trophy",
    ...
    public static final Supplier<Block> TROPHY_CRATE = BLOCKS.register("trophy_crate",
